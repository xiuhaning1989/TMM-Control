...
load Dynamic_8_8_f=20_polarization_transformation.mat
filename1 = 'lattice_8_8_transformation_pointforce.gif';
% load Dynamic_8_8_f=20_polarization_transformation2.mat
% filename1 = 'lattice_8_8_transformation_rightedge_force.gif';
...
%%
% T=[Time(1:20:2001),Time(2001+100:100:end)];
T=9.4%Time(1:50:end);
x=0;y=0;
figure;
...
%         subplot(4,1,4);
%         plot(Rotor_x,Rotor_y,'k--',Rotor_xd,Rotor_yd,'r-','linewidth',1.0);
% %         axis equal    
        xlim([-7 11])
        ylim([-1.5 9]) 
    
%         title('highest optical mode' )
%         xlabel('1D chain span')
%         ylabel('Displacement')
    ...
    if tt == 1 
        ...
        imwrite(imind1,cm1,filename1,'gif','WriteMode','append','DelayTime',0);
    end
end   
