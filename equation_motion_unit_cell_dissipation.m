...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a_b=configuration(1,1);b_b=configuration(1,2);c_b=configuration(1,3);
psi_ab=configuration(1,4);psi_bb=configuration(1,5);psi_cb=configuration(1,6);
a_r=configuration(2,1);b_r=configuration(2,2);c_r=configuration(2,3);
psi_ar=configuration(2,4);psi_br=configuration(2,5);psi_cr=configuration(2,6);
m_b=configuration(3,1);m_r=configuration(3,2);
k_bond=configuration(3,3);k_spring=configuration(3,4);
eta_bond=configuration(3,5);eta_spring=configuration(3,6);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
