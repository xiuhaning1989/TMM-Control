...
%%  %Create all names of variables related to unit cell of i,j
        ...
        result = strcat(num2str(i),num2str(j),num2str(1),num2str(1));       Uij_entire(1) = str2num(result);
        result = strcat(num2str(i),num2str(j),num2str(2),num2str(1));       Uij_entire(2) = str2num(result);
        result = strcat(num2str(i),num2str(j),num2str(1),num2str(2));       Uij_entire(3) = str2num(result);
        result = strcat(num2str(i),num2str(j),num2str(2),num2str(2));       Uij_entire(4) = str2num(result);
        result = strcat(num2str(i),num2str(j),num2str(1),num2str(3));       Uij_entire(5) = str2num(result);
        result = strcat(num2str(i),num2str(j),num2str(2),num2str(3));       Uij_entire(6) = str2num(result);
        result = strcat(num2str(i+1),num2str(j),num2str(1),num2str(1));     Uij_entire(7) = str2num(result);
        result = strcat(num2str(i+1),num2str(j),num2str(2),num2str(1));     Uij_entire(8) = str2num(result);
        result = strcat(num2str(i-1),num2str(j),num2str(1),num2str(1));     Uij_entire(9) = str2num(result);
        result = strcat(num2str(i-1),num2str(j),num2str(2),num2str(1));     Uij_entire(10) = str2num(result);
        result = strcat(num2str(i-1),num2str(j),num2str(1),num2str(3));     Uij_entire(11) = str2num(result);
        result = strcat(num2str(i-1),num2str(j),num2str(2),num2str(3));     Uij_entire(12) = str2num(result);
        result = strcat(num2str(i),num2str(j+1),num2str(1),num2str(2));     Uij_entire(13) = str2num(result);
        result = strcat(num2str(i),num2str(j+1),num2str(2),num2str(2));     Uij_entire(14) = str2num(result);
        result = strcat(num2str(i-1),num2str(j-1),num2str(1),num2str(3));   Uij_entire(15) = str2num(result);
        result = strcat(num2str(i-1),num2str(j-1),num2str(2),num2str(3));   Uij_entire(16) = str2num(result);
        result = strcat(num2str(i),num2str(j-1),num2str(1),num2str(1));     Uij_entire(17) = str2num(result);
        result = strcat(num2str(i),num2str(j-1),num2str(2),num2str(1));     Uij_entire(18) = str2num(result);
        result = strcat(num2str(i+1),num2str(j+1),num2str(1),num2str(2));   Uij_entire(19) = str2num(result);
        result = strcat(num2str(i+1),num2str(j+1),num2str(2),num2str(2));   Uij_entire(20) = str2num(result);
        if j<10
...
if i==1 && j<m+1 %Points at bottom
    ...
    co_damping_ab=((uijx3-ui1jx1+ab_c)*(duijx3-dui1jx1)+(uijy3-ui1jy1-ab_s)*(duijy3-dui1jy1))/...
        coefficient_damping_ab(ui1jx1,uijx3,ui1jy1,uijy3,theta(i,j),alpha(i,j));
    co_damping_bb=((uijx3-ui1j1x2+bb_c)*(duijx3-dui1j1x2)+(uijy3-ui1j1y2-bb_s)*(duijy3-dui1j1y2))/...
        coefficient_damping_bb(ui1j1x2,uijx3,ui1j1y2,uijy3,theta(i,j),alpha(i,j));
    %dx/dt
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_b)*(k1*(uijx3-ui1jx1+ab_c)*coefficient_spring_ab(ui1jx1,uijx3,ui1jy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijx3-ui1j1x2+bb_c)*coefficient_spring_bb(ui1j1x2,uijx3,ui1j1y2,uijy3,theta(i,j),alpha(i,j))+...
         eta1*(uijx3-ui1jx1+ab_c)*co_damping_ab+eta1*(uijx3-ui1j1x2+bb_c)*co_damping_bb);
    %dy/dt
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_b)*(k1*(uijy3-ui1jy1-ab_s)*coefficient_spring_ab(ui1jx1,uijx3,ui1jy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijy3-ui1j1y2-bb_s)*coefficient_spring_bb(ui1j1x2,uijx3,ui1j1y2,uijy3,theta(i,j),alpha(i,j))+...
...
elseif i==n+1 && j<m+1%Points at top
    ...
    co_damping_br=((uijx3-uijx1+br_c)*(duijx3-duijx1)+(uijy3-uijy1-br_s)*(duijy3-duijy1))/...
        coefficient_damping_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j));
    co_damping_cr=((uijx3-uijx2-ar_c+br_c)*(duijx3-duijx2)+(uijy3-uijy2+ar_s-br_s)*(duijy3-duijy2))/...
        coefficient_damping_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j));
    %dx/dt
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r)*(k1*(uijx3-uijx1+br_c)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijx3-uijx2-ar_c+br_c)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
         eta1*(uijx3-uijx1+br_c)*co_damping_br+eta1*(uijx3-uijx2-ar_c+br_c)*co_damping_cr);
    %dy/dt
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r)*(k1*(uijy3-uijy1-br_s)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijy3-uijy2+ar_s-br_s)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
...
elseif j<m+1  %All other points of uijx/y3 inside
    ...
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r+m_b)*(k1*(uijx3-uijx1+br_c)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijx3-uijx2-ar_c+br_c)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijx3-ui1jx1+ab_c)*coefficient_spring_ab(ui1jx1,uijx3,ui1jy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijx3-ui1j1x2+bb_c)*coefficient_spring_bb(ui1j1x2,uijx3,ui1j1y2,uijy3,theta(i,j),alpha(i,j))+...
         eta1*(uijx3-uijx1+br_c)*co_damping_br+eta1*(uijx3-uijx2-ar_c+br_c)*co_damping_cr+...
         eta1*(uijx3-ui1jx1+ab_c)*co_damping_ab+eta1*(uijx3-ui1j1x2+bb_c)*co_damping_bb);
    %dy/dt
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r+m_b)*(k1*(uijy3-uijy1-br_s)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijy3-uijy2+ar_s-br_s)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijy3-ui1jy1-ab_s)*coefficient_spring_ab(ui1jx1,uijx3,ui1jy1,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijy3-ui1j1y2-bb_s)*coefficient_spring_bb(ui1j1x2,uijx3,ui1j1y2,uijy3,theta(i,j),alpha(i,j))+...
         eta1*(uijy3-uijy1-br_s)*co_damping_br+eta1*(uijy3-uijy2+ar_s-br_s)*co_damping_cr+...
         eta1*(uijy3-ui1jy1-ab_s)*co_damping_ab+eta1*(uijy3-ui1j1y2-bb_s)*co_damping_bb);
end        
...
if j==1  %Points at left
    ...
    co_damping_ar=((uijx2-uijx1+ar_c)*(duijx2-duijx1)+(uijy2-uijy1-ar_s)*(duijy2-duijy1))/...
        coefficient_damping_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j));
    co_damping_cr=((uijx2-uijx3+ar_c-br_c)*(duijx2-duijx3)+(uijy2-uijy3-ar_s+br_s)*(duijy2-duijy3))/...
        coefficient_damping_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j));
    %dx/dt
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r)*(k1*(uijx2-uijx1+ar_c)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
         k1*(uijx2-uijx3+ar_c-br_c)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
         eta1*(uijx2-uijx1+ar_c)*co_damping_ar+eta1*(uijx2-uijx3+ar_c-br_c)*co_damping_cr);
    %dy/dt
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r)*(k1*(uijy2-uijy1-ar_s)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
         k1*(uijy2-uijy3-ar_s+br_s)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
...
elseif j==m+1 %Points at right
    ...
    co_damping_bb=((uijx2-ui_1j_1x3-bb_c)*(duijx2-dui_1j_1x3)+(uijy2-ui_1j_1y3+bb_s)*(duijy2-dui_1j_1y3))/...
        coefficient_damping_bb(uijx2,ui_1j_1x3,uijy2,ui_1j_1y3,theta(i,j),alpha(i,j));
    co_damping_cb=((uijx2-uij_1x1+ab_c-bb_c)*(duijx2-duij_1x1)+(uijy2-uij_1y1-ab_s+bb_s)*(duijy2-duij_1y1))/...
        coefficient_damping_cb(uij_1x1,uijx2,uij_1y1,uijy2,theta(i,j),alpha(i,j));
    %dx/dt
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_b)*(k1*(uijx2-ui_1j_1x3-bb_c)*coefficient_spring_bb(uijx2,ui_1j_1x3,uijy2,ui_1j_1y3,theta(i,j),alpha(i,j))+...
         k1*(uijx2-uij_1x1+ab_c-bb_c)*coefficient_spring_cb(uij_1x1,uijx2,uij_1y1,uijy2,theta(i,j),alpha(i,j))+...
         eta1*(uijx2-ui_1j_1x3-bb_c)*co_damping_bb+eta1*(uijx2-uij_1x1+ab_c-bb_c)*co_damping_cb);
    %dy/dt
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_b)*(k1*(uijy2-ui_1j_1y3+bb_s)*coefficient_spring_bb(uijx2,ui_1j_1x3,uijy2,ui_1j_1y3,theta(i,j),alpha(i,j))+...
         k1*(uijy2-uij_1y1-ab_s+bb_s)*coefficient_spring_cb(uij_1x1,uijx2,uij_1y1,uijy2,theta(i,j),alpha(i,j))+...
...
%%%%%%%%%%%%%%%%%
    ...
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r+m_b)*(k1*(uijx2-uijx1+ar_c)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
         k1*(uijx2-uijx3+ar_c-br_c)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijx2-ui_1j_1x3-bb_c)*coefficient_spring_bb(uijx2,ui_1j_1x3,uijy2,ui_1j_1y3,theta(i,j),alpha(i,j))+...
         k1*(uijx2-uij_1x1+ab_c-bb_c)*coefficient_spring_cb(uij_1x1,uijx2,uij_1y1,uijy2,theta(i,j),alpha(i,j))+...
         eta1*(uijx2-uijx1+ar_c)*co_damping_ar+eta1*(uijx2-uijx3+ar_c-br_c)*co_damping_cr+...
         eta1*(uijx2-ui_1j_1x3-bb_c)*co_damping_bb+eta1*(uijx2-uij_1x1+ab_c-bb_c)*co_damping_cb);
    %dy/dt
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r+m_b)*(k1*(uijy2-uijy1-ar_s)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
         k1*(uijy2-uijy3-ar_s+br_s)*coefficient_spring_cr(uijx2,uijx3,uijy2,uijy3,theta(i,j),alpha(i,j))+...
         k1*(uijy2-ui_1j_1y3+bb_s)*coefficient_spring_bb(uijx2,ui_1j_1x3,uijy2,ui_1j_1y3,theta(i,j),alpha(i,j))+...
         k1*(uijy2-uij_1y1-ab_s+bb_s)*coefficient_spring_cb(uij_1x1,uijx2,uij_1y1,uijy2,theta(i,j),alpha(i,j))+...
         eta1*(uijy2-uijy1-ar_s)*co_damping_ar+eta1*(uijy2-uijy3-ar_s+br_s)*co_damping_cr+...
         eta1*(uijy2-ui_1j_1y3+bb_s)*co_damping_bb+eta1*(uijy2-uij_1y1-ab_s+bb_s)*co_damping_cb);
end       
...
%%
if j<m+1  %All points of uijx/y1 are from u21 to u(n+1)m
%Equations of motion of uijx/y1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if i==2 %Points at bottom
    Uij_inside=zeros(12,1);
    ...
    co_damping_ls1=((uijx1-ui1jx1-br_c+ab_c)*(duijx1-dui1jx1)+(uijy1-ui1jy1+br_s-ab_s)*(duijy1-dui1jy1))/...
        coefficient_damping_ls(uijx1,ui1jx1,uijy1,ui1jy1,theta(i,j),alpha(i,j));
    ...
    co_damping_ab=((uijx1-ui_1jx3-ab_c)*(duijx1-dui_1jx3)+(uijy1-ui_1jy3+ab_s)*(duijy1-dui_1jy3))/...
        coefficient_damping_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j));
    co_damping_cb=((uijx1-uij1x2-ab_c+bb_c)*(duijx1-duij1x2)+(uijy1-uij1y2+ab_s-bb_s)*(duijy1-duij1y2))/...
        coefficient_damping_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j));
    %dx/dt
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r+m_b)*(k2*(uijx1-ui1jx1-br_c+ab_c)*coefficient_spring_ls(uijx1,ui1jx1,uijy1,ui1jy1,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uijx2-ar_c)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uijx3-br_c)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
        k1*(uijx1-ui_1jx3-ab_c)*coefficient_spring_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uij1x2-ab_c+bb_c)*coefficient_spring_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j))+...
    ...
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r+m_b)*(k2*(uijy1-ui1jy1+br_s-ab_s)*coefficient_spring_ls(uijx1,ui1jx1,uijy1,ui1jy1,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uijy2+ar_s)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uijy3+br_s)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
        k1*(uijy1-ui_1jy3+ab_s)*coefficient_spring_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uij1y2+ab_s-bb_s)*coefficient_spring_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j))+...
...
elseif i==n+1 %Points at top
    ...
    co_damping_ls2=((uijx1-ui_1jx1+br_c-ab_c)*(duijx1-dui_1jx1)+(uijy1-ui_1jy1-br_s+ab_s)*(duijy1-dui_1jy1))/...
        coefficient_damping_ls(ui_1jx1,uijx1,ui_1jy1,uijy1,theta(i,j),alpha(i,j));
    co_damping_ar=((uijx1-uijx2-ar_c)*(duijx1-duijx2)+(uijy1-uijy2+ar_s)*(duijy1-duijy2))/...
        coefficient_damping_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j));
    co_damping_br=((uijx1-uijx3-br_c)*(duijx1-duijx3)+(uijy1-uijy3+br_s)*(duijy1-duijy3))/...
        coefficient_damping_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j));
    ...
    du(2*p_x(1)-1) = u(2*p_x(1));
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r+m_b)*(k2*(uijx1-ui_1jx1+br_c-ab_c)*coefficient_spring_ls(ui_1jx1,uijx1,ui_1jy1,uijy1,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uijx2-ar_c)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uijx3-br_c)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
        k1*(uijx1-ui_1jx3-ab_c)*coefficient_spring_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uij1x2-ab_c+bb_c)*coefficient_spring_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j))+...
    ...
    du(2*p_x(2)-1) = u(2*p_x(2));
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r+m_b)*(k2*(uijy1-ui_1jy1-br_s+ab_s)*coefficient_spring_ls(ui_1jx1,uijx1,ui_1jy1,uijy1,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uijy2+ar_s)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uijy3+br_s)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
        k1*(uijy1-ui_1jy3+ab_s)*coefficient_spring_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uij1y2+ab_s-bb_s)*coefficient_spring_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j))+...
...
%%%%%%%%%%%%%%%%%    
    ...
    %dx2/d2t
    du(2*p_x(1)) = -3/(m_r+m_b)*(k2*(uijx1-ui1jx1-br_c+ab_c)*coefficient_spring_ls(uijx1,ui1jx1,uijy1,ui1jy1,theta(i,j),alpha(i,j))+...
        k2*(uijx1-ui_1jx1+br_c-ab_c)*coefficient_spring_ls(ui_1jx1,uijx1,ui_1jy1,uijy1,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uijx2-ar_c)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uijx3-br_c)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
        k1*(uijx1-ui_1jx3-ab_c)*coefficient_spring_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j))+...
        k1*(uijx1-uij1x2-ab_c+bb_c)*coefficient_spring_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j))+...
    ...
    %dy2/d2t
    du(2*p_x(2)) = -3/(m_r+m_b)*(k2*(uijy1-ui1jy1+br_s-ab_s)*coefficient_spring_ls(uijx1,ui1jx1,uijy1,ui1jy1,theta(i,j),alpha(i,j))+...
        k2*(uijy1-ui_1jy1-br_s+ab_s)*coefficient_spring_ls(ui_1jx1,uijx1,ui_1jy1,uijy1,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uijy2+ar_s)*coefficient_spring_ar(uijx1,uijx2,uijy1,uijy2,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uijy3+br_s)*coefficient_spring_br(uijx1,uijx3,uijy1,uijy3,theta(i,j),alpha(i,j))+...
        k1*(uijy1-ui_1jy3+ab_s)*coefficient_spring_ab(uijx1,ui_1jx3,uijy1,ui_1jy3,theta(i,j),alpha(i,j))+...
        k1*(uijy1-uij1y2+ab_s-bb_s)*coefficient_spring_cb(uijx1,uij1x2,uijy1,uij1y2,theta(i,j),alpha(i,j))+...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
end  %end if %All points of uijx/y1 are from u21 to u(n+1)m
end  %end if %Only bottom points from u1j, and all other points are from u2j to u(n+1)j
